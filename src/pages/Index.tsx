        ...
        <section className="relative overflow-hidden rounded-3xl gradient-hero-remix-orange shadow-elegant mb-16">
          <div className="relative container mx-auto px-4 py-12 md:py-20">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              {/* Left: Copy */}
              <div>
                <h1 className="text-5xl mb-6 bg-gradient-to-r from-primary via-primary-glow to-primary bg-clip-text text-transparent leading-tight md:text-6xl font-bold">Notebot AI -Click, Convert, Create, Conquer, Chat -Your AI Toolbox for Everything</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="px-8 py-6 gradient-primary shadow-glow transition-smooth" asChild>
                    <a href="#tools" aria-label="Explore all tools" className="shadow-white ">Explore All Tools</a>
                  </Button>
