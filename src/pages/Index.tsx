      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="relative overflow-hidden rounded-3xl gradient-hero shadow-elegant mb-16">
          <div className="relative container mx-auto px-4 py-12 md:py-20">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              {/* Left: Copy */}
              <div>
                <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary via-primary-glow to-primary bg-clip-text text-transparent leading-tight text-left">Click, Convert, Create, Conquer, Chat — Notebot AI for Everything</h1>
        ...
        <section id="tools" aria-label="Tools grid" className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
             {tools.map(({ title, desc, to, iconSrc, alt }) => (
