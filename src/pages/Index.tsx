...
const Index = () => {
  const tools = [
    { title: 'Image → PDF', desc: 'Combine images into a single PDF.', to: '/tools/image-to-pdf', icon: ImageIcon },
    { title: 'Text → PDF', desc: 'Turn notes into clean PDFs.', to: '/tools/text-to-pdf', icon: FileText },
    { title: 'PDF Merge', desc: 'Combine multiple PDFs quickly.', to: '/tools/pdf-merge', icon: Layers },
    { title: 'PDF Split', desc: 'Split pages into separate PDFs.', to: '/tools/pdf-split', icon: Scissors },
    { title: 'PDF → Word', desc: 'Convert PDFs to editable docs.', to: '/tools/pdf-to-word', icon: FileText },
    { title: 'Excel → PDF', desc: 'Make spreadsheets easy to read.', to: '/tools/excel-to-pdf', icon: FileSpreadsheet },
    { title: 'PDF Compressor', desc: 'Reduce PDF size smartly.', to: '/tools/pdf-compress', icon: Shield },
    { title: 'JPG ↔ PDF', desc: 'Images to PDFs and back.', to: '/tools/jpg-to-pdf', icon: FileImage },
    { title: 'PDF ↔ JPG', desc: 'Export pages as images.', to: '/tools/pdf-to-jpg', icon: FileImage },
    { title: 'Resume Builder', desc: 'Create a job-ready resume.', to: '/tools/resume-builder', icon: FileText },
    { title: 'OCR (Handwriting → Text)', desc: 'Scan and digitize notes.', to: '/tools/ocr', icon: QrCode },
    { title: 'Poster / Flyer Maker', desc: 'Design eye-catching posters.', to: '/tools/poster-maker', icon: Paintbrush },
  ] as const;
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section id="tools" aria-label="Tools grid" className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {tools.map(({ title, desc, to, icon: Icon }) => (
